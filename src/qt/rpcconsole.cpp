...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RickCoin RPC console.") + "<br>" +
...
{
    QScrollRCK *scrollRCK = ui->messagesWidget->verticalScrollRCK();
    scrollRCK->setValue(scrollRCK->maximum());
}
